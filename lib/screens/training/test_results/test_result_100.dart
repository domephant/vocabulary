...
class TestResult100Screen extends StatelessWidget {
  const TestResult100Screen({Key? key}) : super(key: key);
            ...
            children: [
              ...
              SizedBox(
                ...
                child: FittedBox(
                  ...
                  child: Lottie.asset(
                    'images/lotties/training/test_results/lottie_resultscreen_stage6.json',
                    fit: BoxFit.fitWidth,
                    width: constraints.maxWidth,
                    repeat: false,
