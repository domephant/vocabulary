...
class TestResult25Screen extends StatelessWidget {
  const TestResult25Screen({Key? key}) : super(key: key);
            ...
            children: [
              ...
              SizedBox(
                ...
                child: FittedBox(
                  ...
                  child: Lottie.asset(
                    'images/lotties/training/test_results/lottie_resultscreen_stage1.json',
                    fit: BoxFit.fitWidth,
                    width: constraints.maxWidth,
                    repeat: false,
                  ),
