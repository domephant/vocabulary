...
class TestResult90Screen extends StatelessWidget {
  const TestResult90Screen({Key? key}) : super(key: key);
            ...
            children: [
              ...
              SizedBox(
                ...
                child: FittedBox(
                  ...
                  child: Lottie.asset(
                    'images/lotties/training/test_results/lottie_resultscreen_stage5.json',
                    fit: BoxFit.fitWidth,
                    width: constraints.maxWidth,
                    repeat: false,
